...
【你可以檢查的面向】
- 任務名稱是否讓人看不懂在做什麼（不是「可以更具體」，是「看不懂」）
...
- 盡量保留孩子可以自己決定的部分。
- 任務名稱的建議門檻要拉高：只有「看了不知道要做什麼」才值得提，
  「已經看得懂、只是可以寫得更具體」不構成建議理由。名稱調整對家長來說
  通常不是最需要的部分，時間安排、範圍大小、回顧時機、里程碑是否清楚
  這些欄位的建議通常更有幫助——建議名額有限時，優先讓給這些欄位。
